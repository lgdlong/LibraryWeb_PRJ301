    ...
    <div class="card shadow p-4" style="width: 400px;">
        ...
        <form action="RegisterController" method="post">
            ...
            <div class="mb-3">
                ...
                <% if (userError.getFullnameError() != null) { %>
                    <div class="text-danger small mt-1"><%= userError.getFullnameError() %></div>
                <% } %>
            </div>
            ...
            <div class="mb-3">
                ...
                <% if (userError.getPasswordError() != null) { %>
                    <div class="text-danger small mt-1"><%= userError.getPasswordError() %></div>
                <% } %>
            </div>
            ...
            <div class="mb-3">
                ...
                <% if (userError.getConfirmError() != null) { %>
                    <div class="text-danger small mt-1"><%= userError.getConfirmError() %></div>
                <% } %>
            </div>
