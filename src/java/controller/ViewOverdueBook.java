...
public class ViewOverdueBook extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<BorrowRecordDTO> overdueList = borrowService.getAllOverdue();

        request.setAttribute("overdueList", overdueList);
        request.setAttribute("pageTitle", "Overdue Books");
        request.setAttribute("contentPage", "/user/OverdueBook.jsp");
